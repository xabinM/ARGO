# config/settings.py - 수정된 설정 파일
"""
🎯 ARGO AI Server 통합 설정 (Pydantic v2 호환)
"""

import os
from typing import List, Optional
from pydantic import Field
from pydantic_settings import BaseSettings  # 수정: pydantic-settings에서 import
import torch
...
class Settings(BaseSettings):
    ...
    YOLO_MODEL_PATH: str = Field(
        default="object_detect/model/yolov8m.pt",  # 실제 경로로 수정
        env="YOLO_MODEL_PATH"
    )
